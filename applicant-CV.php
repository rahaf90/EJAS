...
<html lang="en">
    <head>
     ...
     function add_feed()
	          ...
	          // Get template data
	            div1.innerHTML = document.getElementById('educationnew').innerHTML;
	          // append to our form, so that template data
	         //become part of form
	         document.getElementById('education').appendChild(div1);}
            function add_feed_for_experience()
                {
	            var div1 = document.createElement('div');
	          // Get template data
	            div1.innerHTML = document.getElementById('experiencenew').innerHTML;
	          // append to our form, so that template data
	         //become part of form
	         document.getElementById('experience').appendChild(div1);}
            function add_feed_for_certification()
                {
	            var div1 = document.createElement('div');
	          // Get template data
	            div1.innerHTML = document.getElementById('certificationnew').innerHTML;
	          // append to our form, so that template data
	         //become part of form
	         document.getElementById('certification').appendChild(div1);}
            function add_feed_for_skill()
                {
	            var div1 = document.createElement('div');
	          // Get template data
	            div1.innerHTML = document.getElementById('skillsnew').innerHTML;
	          // append to our form, so that template data
	         //become part of form
	         document.getElementById('skills').appendChild(div1);}
            function add_feed_for_language()
                {
	            var div1 = document.createElement('div');
	          // Get template data
	            div1.innerHTML = document.getElementById('languagesnew').innerHTML;
	          // append to our form, so that template data
	         //become part of form
