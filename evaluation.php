...
{
	var ele = frm.elements['graduationyear[]'];
	if (! ele.length)
	{
		alert(ele.value);
	}
	...
	return true;
     ...
     var ct = 1;
	      ...
	      var delLink = '<div style="text-align:right;margin-right:65px"><a href="javascript:delIt_age('+ ct +')">Del</a></div>';
        ...
        var ct_edu = 1;
	       ...
	       div1.id = ct_edu;
	       // link to delete extended form elements
	      var delLink = '<div style="text-align:right;margin-right:65px"><a href="javascript:delIt_education('+ ct_edu +')">Del</a></div>';
